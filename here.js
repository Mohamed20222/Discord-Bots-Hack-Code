...
const x_x = "." //$start //the command to start the hack system
...
const spam = "HJACKED" // HACKED HACKED HACKED//the spam message
...
const adminstrator = 'OP' //KING OF UNKNOWN //the op name
